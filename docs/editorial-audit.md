...
> Згенеровано: 20 вересня 2026 р. о 10:42
...
| Категорія | Статей | Сигналів | Причина |
|-----------|--------|----------|---------|
...
- `chomu-lyudy-povertayutsya-pislya-rozryvu` — Чому люди повертаються після розриву _(relationships)_
...
- `chomu-lyudy-povertayutsya-pislya-rozryvu` — Чому люди повертаються після розриву
...
**Без sourceArticle:** 4 постів
  - `04-kholodnist-plutayut-z-hlybynoju` (signal)
  - `05-socialnyy-status` (fragment)
  - `06-manipulyaciya-chy-mezha` (signal)
  - `07-mekhanizm-prodovzhuyetsya` (signal)
...
| Slug | Тип | Reading time |
|------|-----|-------------|
| `chomu-horoshykh-lyudey-chasto-ne-hochut` | `pillar_article` | 1 хв |
| `chomu-pislya-blyzkosti-lyudy-stayut-kholodnymy` | `pillar_article` | 1 хв |
| `emotsiyna-zalezhnist-chomu-my-trymayemosya-za-tykh-khto-ranyt` | `pillar_article` | 1 хв |
| `hroshi-i-sorom-chomu-bidnist-zdayetsya-moralnoyu-porazkoyu` | `pillar_article` | 1 хв |
| `konflikt-u-pari-chomu-svarka-ne-pro-te-z-choho-pochalas` | `pillar_article` | 1 хв |
| `revnoshchi-strakh-vtraty-chy-bazhannya-kontrolyu` | `pillar_article` | 1 хв |
| `seks-i-status-chomu-potyah-ridko-buvaye-vypadkovym` | `pillar_article` | 1 хв |
| `sotsialni-lifty-chomu-odnym-vdalosya-a-inshym-ni` | `deep_analysis` | 3 хв |
| `toksychni-lyudy-chomu-vony-zdayutsya-sylnymy` | `pillar_article` | 1 хв |
| `why-good-people-are-often-not-desired` | `deep_analysis` | 5 хв |

## 8. Можливі дублювання

- `cholovik-yakyi-vidpovivav-cherez-try-dni` / `deep-analysis-movchannya-yak-prykhovanyy-kontrol`
  _Спільні теги (мовчання, стосунки, контроль)_
- `cholovik-yakyi-vidpovivav-cherez-try-dni` / `fragment-movchannya-ne-pauza`
  _Спільні теги (мовчання, стосунки, контроль)_
- `cholovik-yakyi-vidpovivav-cherez-try-dni` / `fragment-movchannya-pislya-konfliktu`
  _Спільні теги (мовчання, стосунки, контроль)_
- `chomu-horoshykh-lyudey-chasto-ne-hochut` / `chomu-nevyznachenist-vyklykaye-sylnishi-emotsiyi`
  _Спільні теги (стосунки, потяг, емоційна залежність)_
- `chomu-horoshykh-lyudey-chasto-ne-hochut` / `why-good-people-are-often-not-desired`
  _Спільні теги (стосунки, потяг, емоційна залежність)_
- `chomu-ignor-stvoryuye-fantaziyu` / `chomu-lyudy-znykayut-bez-poyasnennya`
  _Спільні теги (ігнор, прив'язаність, мовчання, невизначеність)_
- `chomu-ignor-stvoryuye-fantaziyu` / `chomu-nevyznachenist-sylnisha-za-pryame-ni`
  _Спільні теги (мовчання, невизначеність, тривога)_
- `chomu-ignor-stvoryuye-fantaziyu` / `chomu-pryvyazuyemos-do-nestachi-vidpovidi`
  _Спільні теги (ігнор, прив'язаність, невизначеність)_
- `chomu-ignor-stvoryuye-fantaziyu` / `deep-analysis-movchannya-yak-prykhovanyy-kontrol`
  _Спільні теги (ігнор, прив'язаність, мовчання, тривога)_
- `chomu-ignor-stvoryuye-fantaziyu` / `fragment-ignor-stvoryuye-fantaziyu`
  _Спільні теги (ігнор, фантазія, тривога)_

## 9. Рекомендовані теми

| Тема | Чому | Що створити |
|------|------|-------------|
...
| **Нд** | Читання, редакторський огляд, коригування плану на наступний тиждень | 🔍 review |
